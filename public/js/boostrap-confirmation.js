      ...
      function m(t, e) {
        ...
        return (
          ...
          e.selector
            ...
            : e._selector
            ? ((n.config._selector = e._selector), (n._isDelegate = !0))
      ...
      return (
        ...
        (I._setConfirmationListeners = function () {
          ...
          this.config.selector
            ...
            : (t(this.element).on(this.config.trigger, function (t, e) {
                e ||
                  (t.preventDefault(),
                  t.stopPropagation(),
                  t.stopImmediatePropagation());
            ...
            this._isDelegate ||
              ((this.eventBody = !1),
              (this.uid = this.element.id || m.getUID(r + "_group")),
              t(this.element).on(v.SHOWN, function () {
                e.config.popout &&
                  !e.eventBody &&
                  (e.eventBody = t("body").on(
                    v.CLICK + "." + e.uid,
                    function (n) {
                      t(e.config._selector).is(n.target) ||
                        t(e.config._selector).has(n.target).length > 0 ||
                        (t(e.config._selector)
                          .filter(function () {
                            return void 0 !== t(this).data(s);
                          })
                          .confirmation("hide"),
                        t("body").off(v.CLICK + "." + e.uid),
                        (e.eventBody = !1));
                    }
                  ));
              }));
        ...
        (I._setButtons = function (e, n) {
          ...
          n.forEach(function (e) {
            var n = t('<a href="#"></a>')
              ...
              .html(e.label || "")
              .attr(e.attr || (e.cancel ? {} : o.config._attributes));
            (e.iconClass || e.iconContent) &&
              ...
              n.one("click", function (n) {
                "#" === t(this).attr("href") && n.preventDefault(),
                  ...
                  e.cancel
                    ? (o.config.onCancel.call(o.element, e.value),
                      t(o.element).trigger(v.CANCELED, [e.value]))
                    : (o.config.onConfirm.call(o.element, e.value),
                      t(o.element).trigger(v.CONFIRMED, [e.value]),
                      t(o.element).trigger(o.config.confirmationEvent, [!0])),
                  o.hide();
              }),
              i.append(n);
          });
        ...
        (I._setupKeyupEvent = function () {
          (u = this),
            t(window).off(v.KEYUP).on(v.KEYUP, this._onKeyup.bind(this));
        }),
        ...
        (I._onKeyup = function (e) {
          if (this.tip) {
            ...
            switch (i) {
              ...
              case "ArrowLeft":
                (n =
                  s.length && s.prev().length ? s.prev() : r.children().last()),
                  s.removeClass("active"),
                  n.addClass("active").focus();
            }
        ...
        (m._jQueryInterface = function (e) {
          return this.each(function () {
            var n = t(this).data(s),
              o = "object" == typeof e ? e : {};
            if (
              ((o.rootSelector = t(this).selector || o.rootSelector),
              (n || !/destroy|hide/.test(e)) &&
                (n || ((n = new m(this, o)), t(this).data(s, n)),
                "string" == typeof e))
            ) {
              if (void 0 === n[e])
